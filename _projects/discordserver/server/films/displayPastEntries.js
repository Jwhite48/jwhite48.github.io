module.exports = {
  getHTML: function() {
    ...
    var html = client.connect().then(function(db) {
      ...
      var masterMustache = ''; var yearsArr = []; var order = 0;
      var template = fs.readFileSync('./films/generate-past-entries.html', 'utf-8');
      for(const key in collections){
        ...
        date: function(){
          return (this.release_date.substring(0, this.release_date.indexOf('-'))).trim();
        }
        });
      }
      template = fs.readFileSync('./films/master-past-entries.html', 'utf-8');
